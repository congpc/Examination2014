...
/**
 * Todo list:
 * Online Tool encript text at http://www.xorbin.com/tools/sha1-hash-calculator
 * - Test encript by SHA265, should return the same value, when encript a text.
 * - Test encript by SHA1, should return the same value, when encript a text.
 * - Test encript by MD5, should return the same value, when encript a text.
 * - Test HKDF, should return true, when input text list
 * - Test encript and decript by AES, should return true, when input values define by CBC mode and OFB mode.
 * - Test encript and decript by DES2, should return true, when input a text.
 * - Test encript and decript by DES, should return true, when input a text.
 * - Test encript and decript by HMAC, should return true, when input a text.
 */
@interface IPaSecurityTests : XCTestCase

@end

@implementation IPaSecurityTests
...
#pragma mark - Tests
- (void)testSHA265_ShouldReturnTheSameValue_WhenEncriptText {
    //GIVEN
    NSString *value = @"Cong";
    NSString *expected = @"50d69dce0ae77a8c25fbcbca8b643ad960f2143908fa03408720335b6d4862c2";
    
    //WHEN
    NSString *encriptedValue = [value SHA256String];
    
    //THEN
    XCTAssertEqualObjects(expected, encriptedValue, @"Test encript by SHA265 string");
}
- (void)testSHA1_ShouldReturnTheSameValue_WhenEncriptText {
    //GIVEN
    NSString *value = @"Cong";
    NSString *expected = @"893ca2d92d84e6d8936cb2f1f6d1894bc8f38367";
    
    //WHEN
    NSString *encriptedValue = [value SHA1String];
    
    //THEN
    XCTAssertEqualObjects(expected, encriptedValue, @"Test encript by SHA1 string");
}
- (void)testMD5_ShouldReturnTheSameValue_WhenEncriptText {
    //GIVEN
    NSString *value = @"Cong";
    NSString *expected = @"475385479ac4ec99438c7a92e296bdff";
    
    //WHEN
    NSString *encriptedValue = [value MD5String];
    
    //THEN
    XCTAssertEqualObjects(expected, encriptedValue, @"Test encript by MD5 string");
}
-(void)testHKDF_ShouldReturnTrue_WhenInputTextList {
    //GIVEN
...
-(void)testAES_ShouldReturnTrue_WhenInputValuesDefineByCBCAndOFB {
    //http://aes.online-domain-tools.com/ using Hexa data
    //GIVEN
    NSDictionary *testCaseList = @{@(kCCModeCBC):@[@{@"Key": @"06a9214036b8a15b512e03d534120006",
                                                   ...
                                                   @{@"Key": @"56e47a38c5598974bc46903dba290349",
                                                     @"PlainText":@"a0a1a2a3a4a5a6a7a8a9aaabacadaeafb0b1b2b3b4b5b6b7b8b9babbbcbdbebfc0c1c2c3c4c5c6c7c8c9cacbcccdcecfd0d1d2d3d4d5d6d7d8d9dadbdcdddedf",
                                                     @"realCipherData":@"c30e32ffedc0774e6aff6af0869f71aa0f3af07a9a31a9c684db207eb0ef8e4e35907aa632c3ffdf868bb7b29d3d46ad83ce9f9a102ee99d49a53e87f4c3da55",
                                                     @"iv":@"8ce82eefbea0da3c44699ed7db51b7d9"}],
                                   @(kCCModeOFB):@[@{@"Key": @"95273b071820f54ed10df47458997e5188821e0073579cdfc097426cdbc947d5", @"PlainText":@"303931363262383862636434343431333832353130313261633830653134343461383230323539617c312e317c6c6f67696e7c323031332d30312d30315431323a33343a35365a7c2d2de6b8ace8a9a6e8b387e696992d2d6221bcbc273da52c746c0ce91025990626ef3338", @"realCipherData":@"1026753f3cf36eccddf4b75736e42fc958a12f5eac3f38d380842dcf1b5bae7fcdd2752db4b1cdf15f0e8d658bacca1b64ab142dd65e8057f201417021c4743382ea4ec088968e5771f5c1347ce74fd924166168d0e397e70bb58cd158ff58dad274792ed4b2c3151522ff4e"}]};
    
    //WHEN + THEN
    for (NSNumber *testMode in testCaseList) {
        NSArray *testList  = testCaseList[testMode];
        CCMode mode = [testMode intValue];
...
-(void)testDES2_ShouldReturnTrue_WhenInputValues {
    //GIVEN
    NSDictionary *testData = @{@"email":@"aaaaaaaaaa@gmail.com",
    ...
    NSData *encryptData = [data EncryotWithAlgorighm:kCCAlgorithmDES mode:kCCModeECB
                                             padding:YES iv:nil
                                                 key:[NSData dataFromHexString:@"38627974656B6579"]];
    
    
    
    data = [encryptData DecryotWithAlgorighm:kCCAlgorithmDES mode:kCCModeECB
                                     padding:YES iv:nil
                                         key:[NSData dataFromHexString:@"38627974656B6579"]];
...
-(void)testDES_ShouldReturnTrue_WhenInputValues {
    //GIVEN
...
-(void)testHmac_ShouldReturnTrue_WhenInputValues {
    //GIVEN
    ...
    for (NSNumber *algorithmKey in testData) {
        for (NSDictionary *tData in testData[algorithmKey]) {
            ...
            CCHmacAlgorithm algorithm = [algorithmKey intValue];
